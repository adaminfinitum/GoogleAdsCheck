"""
Google ads does not allow ads for substances that alter mental state for the purpose of recreation
...
for x in states:
    for i in keywords:
        ...
        #Find all inputs on google page
        inputs = driver.find_elements_by_tag_name('input')
        #The 3rd input is the main search input
        #Clicking it will make it focus
        inputs[2].click()
        #On focus send keyword plus state
        inputs[2].send_keys(i + ' ' + x, Keys.ENTER)
